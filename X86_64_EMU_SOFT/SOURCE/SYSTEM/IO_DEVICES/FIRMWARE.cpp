...
uint8_t X86_64_EMU_SOFT::SYSTEM::IO_DEVICES::FirmwareRomDevice::Read8(uint64_t offset) const noexcept
{
    ValidateDeviceAccess(offset, 1, memory.size());
    return memory[offset];
}

uint16_t X86_64_EMU_SOFT::SYSTEM::IO_DEVICES::FirmwareRomDevice::Read16(uint64_t offset) const noexcept
{
...
uint32_t X86_64_EMU_SOFT::SYSTEM::IO_DEVICES::FirmwareRomDevice::Read32(uint64_t offset) const noexcept
{
...
uint64_t X86_64_EMU_SOFT::SYSTEM::IO_DEVICES::FirmwareRomDevice::Read64(uint64_t offset) const noexcept
{
