...
namespace X86_64_EMU_SOFT::TESTS {
	...
	namespace ALU_DECODING_TESTS
	{
		...
		//TODO : Isert tests from 0xe to 0x19
		...
		TEST_CLASS(Test_Handle_AND_rm8_r8_0x20) {
			TestEnvironment env;
			TEST_METHOD_INITIALIZE(Init) {
				env = TestEnvironment();
				Boilerplate::SetRegistersAscending(env.vCoreLong);
		...
		TEST_CLASS(Test_Handle_AND_rm16rm32rm64_r16r32r64_0x21) {
			TestEnvironment env;
			TEST_METHOD_INITIALIZE(Init) {
				env = TestEnvironment();
				Boilerplate::SetRegistersAscending(env.vCoreLong);
		...
		TEST_CLASS(Test_Handle_AND_r8_rm8_0x22) {
			TestEnvironment env;
			TEST_METHOD_INITIALIZE(Init) {
				env = TestEnvironment();
				Boilerplate::SetRegistersAscending(env.vCoreLong);
		...
		TEST_CLASS(Test_Handle_AND_r16r32r64_rm16rm32rm64_0x23) {
			TestEnvironment env;
			TEST_METHOD_INITIALIZE(Init) {
				env = TestEnvironment();
				Boilerplate::SetRegistersAscending(env.vCoreLong);
		...
		TEST_CLASS(Test_Handle_AND_AL_imm8_0x24) {
			TestEnvironment env;
			TEST_METHOD_INITIALIZE(Init) {
				env = TestEnvironment();
				Boilerplate::SetRegistersAscending(env.vCoreLong);
		...
		TEST_CLASS(Test_Handle_AND_AxEaxRax_imm16imm32_0x25) {
			TestEnvironment env;
			TEST_METHOD_INITIALIZE(Init) {
				env = TestEnvironment();
				Boilerplate::SetRegistersAscending(env.vCoreLong);
